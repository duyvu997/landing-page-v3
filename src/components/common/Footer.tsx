...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    if (addressCount < 3) {
      ...
      setGridCols('grid-cols-1 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-3');
    }
  }, []);
  ...
  return (
    <>
      <footer>
        ...
        <div className='justify-start md:items-end flex  flex-col-reverse lg:flex-row md:flex-row'>
          <div className='lg:w-1/2 md:w-1/2 h-[286px] lg:h-[200px] md:h-[200px] pt-48 pr-3 pl-40 lg:pt-10 md:pt-10 lg:pb-0 mt-[-10rem] lg:mt-0 bg-[#051219] flex-col lg:flex-row md:flex-row  lg:gap-8 gap-4 inline-flex'>
            <div className='justify-start items-center gap-4 inline-flex w-fit'>
              ...
              <div className="text-white text-base lg:text-xl font-medium leading-normal">
                (+028) 3620 3636
              </div>
            </div>
            <div className="justify-start items-center gap-4 inline-flex w-fit">
          ...
          <div className='z-10 lg:w-1/2 md:w-1/2 flex justify-end'>
            <div className=' self-stretch w-[319px] lg:w-full md:w-full h-[286px]   px-6 py-10 bg-[#38b6ff] rounded-tl-xl flex-col  justify-start items-start inline-flex '>
              <div className='self-stretch h-[206px] flex-col justify-start items-start gap-10 flex'>
                <div className='self-stretch h-[122px] flex-col justify-start items-start gap-4 flex'>
                  ...
                  <div className="self-stretch opacity-70 text-[#02070a] text-sm lg:text-base font-normal leading-[21px]">
              ...
              <div className="rounded-xl justify-start items-center gap-6 inline-flex">
                <div className="text-center text-[#02070a] text-lg font-semibold leading-[27px] tracking-tight">
                  Contact us
                </div>
        ...
        <div className="px-6 py-8 ">
          {/* Address Section */}
          <div className={`grid ${gridCols} gap-8 lg:px-[15%] md:px-[10%]  lg:py-[4%] md:py-[4%]`}>
            {addresses.map((item, index) => (
              <div key={index} className="mb-6 flex items-start space-x-2">
                <div>
